...
assertIncludes('6월 동시+반값', 'main dashboard promo badge');
assertIncludes('6월 프로모션 안내', 'notice title');
assertIncludes('2026.06.05 업데이트', 'notice update date');
assertIncludes('2대 이상 10% 할인과 약정별 반값 혜택을 함께 적용합니다.', 'bundle plus half notice copy');
